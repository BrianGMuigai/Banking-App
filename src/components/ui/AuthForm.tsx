  ...
  return (
    <section className= "auth-form">
      ...
      <Link href="/"
            ...
            <h1 className = "text-26 font-ibm-plex-serif font-bold text-black-1">Haven Finance</h1>
            </Link>
      ...
      <CustomInput
       ...
       <CustomInput
        ...
        />
             <CustomInput
        control={form.control} name="city" label="City" placeholder="Example:Nairobi"
        />
          <div className="flex gap-4">
          <CustomInput
        control={form.control} name="state" label="State" placeholder="Example: Starehe"
        />
      <CustomInput
